...
<style>
  /* Reusable project block styling */
  .project {
    clear: both;
    margin-bottom: 2.2rem; /* Abstand zwischen Projekten */
  }

  /* Make project images consistent */
  .project img {
    float: right;
